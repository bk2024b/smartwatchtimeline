...
const fields = [
  ...
  ['water_rating','Water rating','text'], ['display_type','Display type','text'], ['ecosystem','Ecosystem','text'], ['os','OS','text'], ['image_url','Image URL','text'], ['image_count','Image count','number'], ['source_primary','Primary source','text'], ['source_secondary','Secondary source','text'], ['source_checked_at','Source checked at','date'], ['data_confidence','Data confidence','text'],
];
...
export default function AdminSmartwatchEditor() {
  ...
  const [watch, setWatch] = useState(null); const [brands, setBrands] = useState([]); const [message, setMessage] = useState(''); const [saving, setSaving] = useState(false);
